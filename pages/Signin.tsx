        ...
        <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
          ...
          <div className='w-full md:w-[67%] lg:w-[50%] lg:ml-12'>
            <form>
              ...
              <button className='w-full bg-blue-600 text-white px-7 py-3 rounded text-sm font-medium uppercase shadow-md hover:bg-blue-800 transition duration-150 ease-in-out hover:shadow-lg active:bg-blue-900' type="submit">Sign in</button>
